<div>
    ...
    <div>
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="servicos-tab2" data-bs-toggle="tab" data-bs-target="#servicos2" type="button" role="tab" aria-controls="servicos2" aria-selected="true">Serviço</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="rotas-tab2" data-bs-toggle="tab" data-bs-target="#rotas2" type="button" role="tab" aria-controls="rotas2" aria-selected="false">Execução</button>
            </li>
        </ul>
        <div class="tab-content mb-4" id="myTabContent">
            <div class="tab-pane fade show active" id="servicos2" role="tabpanel" aria-labelledby="servicos-tab2">
                <div class="row linha-add position-relative">
                    <div class="col-md-3 mb-3">
                        <label for="inicio">Início</label>
                        <input type="date" class="form-control" name="inicio[]" id="inicio" maxlength="30" required>
            ...
            <div class="tab-pane fade" id="rotas2" role="tabpanel" aria-labelledby="rotas-tab2">
                <div class="row linha-add position-relative">
                    <div class="col-12">
                        <div class="row align-items-center">
                            <div class="col-lg-9">
                                <h4 class="h4 mb-0">Diária 12 Horas SUV Executivo Blindado</h4>
                            </div>
                            <div class="col-lg-3 text-end">
                                <a href="#" class="btn bg-gradient-dark btn-md mt-4 mb-4">Adicionar rota</a>
                            </div>
